...
@Module({
  ...
  providers: [SessionService, RateLimitService, JwtService, FirebaseAdminService, JwtAuthGuard, AdminAuthGuard, OptionalAuthGuard],
  exports: [SessionService, RateLimitService, JwtService, FirebaseAdminService, JwtAuthGuard, AdminAuthGuard, OptionalAuthGuard],
})
